...
<!-- Mirrored from newlife-church-html.axiomthemes.com/cart.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Nov 2019 13:37:37 GMT -->
<head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
        <meta name="format-detection" content="telephone=no">

        <title>Cart &#8211; New Life Church</title>
    ...
    <body class="page body_style_wide body_filled article_style_stretch scheme_original top_panel_show top_panel_above sidebar_hide woocommerce-cart woocommerce-page">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="cart_item">
                                                        ...
                                                        <td class="product-name" data-title="Product">
                                                            <a href="product-single.html/index.php">'God is Love' T-shirt</a>
                                                        </td>
