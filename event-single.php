...
<!-- Mirrored from newlife-church-html.axiomthemes.com/event-single.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Nov 2019 13:35:08 GMT -->
<head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
        <meta name="format-detection" content="telephone=no">

        <title>Event Single &#8211; New Life Church</title>
            ...
            <div class="page_wrap">
                ...
                <div class="top_panel_title top_panel_style_3 title_present breadcrumbs_present scheme_original">
                    <div class="top_panel_title_inner top_panel_inner_style_3 breadcrumbs_block_bg3">
                        <div class="content_wrap">
                            <h1 class="page_title">WOW Conference</h1>
                            <div class="breadcrumbs">
                                <a class="breadcrumbs_item home" href="index.php">Home</a>
                                <span class="breadcrumbs_delimiter"></span>
                                <a class="breadcrumbs_item all" href="#">Upcoming Events</a>
                                <span class="breadcrumbs_delimiter"></span>
                                <span class="breadcrumbs_item current">WOW Conference</span>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div id="tribe-events-pg-template">
                                        <div id="tribe-events" class="tribe-no-js" data-live_ajax="1" data-datepicker_format="0" data-category="">
                                             <span class="tribe-events-ajax-loading">
                                                 <img class="tribe-events-spinner-medium" src="js/vendor/the-events-calendar/images/tribe-loading.gif" alt="Loading Events" /></span>
                                            <div id="tribe-events-content" class="tribe-events-single">
                                                <p class="tribe-events-back">
                                                    <a href="#"> &laquo; All Events</a>
                                                </p>
                                                <!-- Notices -->
                                                <h1 class="tribe-events-single-event-title">WOW Conference</h1>
                                                ...
                                                <div class="tribe_events type-tribe_events">
                                                    <div class="tribe-events-event-image">
                                                        <img src="images/wow-conference.jpg" alt="" />
                                                    </div>
                                                    <!-- Event content -->
                                                    ...
                                                    <div class="tribe-events-single-section tribe-events-event-meta primary tribe-clearfix">
                                                        <div class="tribe-events-meta-group tribe-events-meta-group-details">
                                                            ...
                                                            <dl>
                                                                <dt> Date: </dt>
                                                                <dd>
                                                                    <abbr class="tribe-events-abbr tribe-events-start-date dtstart" title="2017-01-31"> January 31, 2017 </abbr>
                                                                </dd>
                                                                <dt> Time: </dt>
                                                                <dd>
                                                ...
                                                <div id="tribe-events-footer">
                                                    ...
                                                    <ul class="tribe-events-sub-nav">
                                                        <li class="tribe-events-nav-previous">
                                                            <a href="#"><span>&laquo;</span> Seniors Bible Study</a>
                                                        </li>
                                                        <li class="tribe-events-nav-next">
                                                            <a href="#">Monthly Band Tryouts <span>&raquo;</span></a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
...
<!-- Mirrored from newlife-church-html.axiomthemes.com/event-single.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Nov 2019 13:35:23 GMT -->
</html>