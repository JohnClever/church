          ...
          <div class="row gap-20 masonry pos-r">
            ...
            <div class="masonry-item col-md-8">
              <div class="bgc-white p-20 bd">
                <h6 class="c-grey-900">Add event</h6>
                <div class="mT-30">
                  <form id="form" class="addEvent">

                    <div class="form-group">
                      <label for="evnt_name">Title of Events</label>
                      <input name="evnt_name" type="text" class="form-control" id="evnt_name" placeholder="Name of Events">
                    </div>
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input name="evnt_image" type="file" class="form-control" id="evnt_image">
                      </div>

                      <div class="form-group col-md-6">
                        <label for="evnt_date">Date of Event</label>
                        <input name="evnt_date" type="date" class="form-control" id="evnt_date">
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="evnt_des" type="text" class="form-control" rows="6" id="evnt_des" placeholder="Description of Event"></textarea>
                    </div>
