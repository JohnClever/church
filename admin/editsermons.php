                ...
                <div class="mT-30">
                  <form id="form" class="editSermon">
                    ...
                    <div class="form-group">
                      ...
                      <input name="serm_title" type="text" class="form-control" id="serm_title" value="<?php echo $serm_title;?>">
                    </div>
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" name="serm_preacher" class="form-control" id="serm_preacher" value="<?php echo $serm_preacher;?>">
                      </div>

                      <div class="form-group col-md-6">
                        <label for="serm_date">Date of sermon</label>
                        <input name="serm_date" type="date" class="form-control" id="serm_date" value="<?php echo $serm_date;?>">
                      </div>
