...
<!-- Mirrored from newlife-church-html.axiomthemes.com/typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Nov 2019 13:30:44 GMT -->
<head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
        <meta name="format-detection" content="telephone=no">

        <title>Typography &#8211; New Life Church</title>
                        ...
                        <div class="content">
                            <article class="post_item post_item_single page">
                                <section class="post_content">
                                    <!-- Headings -->
                                    <h1 class="sc_title sc_title_regular">H1 Heading</h1>
                                    ...
                                    <p>
                                        <strong>Bold text</strong> dolor sit amet, consectetur
                                        <a href="#">accent color</a> adipisicing elit, sed do eiusmod tempor hovered ut labore et dolore magna aliqua. Mauris
                                        <span class="sc_highlight sc_highlight_style_1">vitae quam</span> ligula. In
                                        <span class="sc_highlight sc_highlight_style_2">tincidunt sapien</span> sed nibh. Maecenas ut libero eu metus tincidunt lobortis. Duis accumsan at mauris vel lacinia. Cras cursus eros vel commodo tincidunt.
                                    </p>
                                    <p>Iste natus error sit voluptatem
                                        <em>italic text</em> example accusantium doloremque. Donec ac urna eget pharetra id massa velit bibendum
                                        <span class="sc_highlight sc_highlight_style_3">scelerisque congue</span> aliquam. Phasellus tempor urna erat, a fringilla elit vulputate in.
                                        <span class="sc_tooltip_parent">Vivamus euismod
                                            <span class="sc_tooltip">Tooltip example</span>
                                        </span> mauris id sodales
                                        <del datetime="2015-11-02T13:16:54+00:00">tincidunt</del>.
                                    </p>
                                    <!-- /Standard Inline Elements -->
                                    <!-- Dropcaps -->
                                    <a id="toc_dropcaps" class="sc_anchor" title="Dropcaps" data-description="{Dropcaps} - |Dropcap styles demonstration" data-icon="icon-info-1" data-url="" data-separator="no"></a>
                                    <div class="sc_line sc_line_position_center_center sc_line_style_solid"></div>
                                    <h2 class="sc_title sc_title_regular">Dropcaps</h2>
                                    <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2 margin_bottom_tiny">
                                        <div class="column-1_2 sc_column_item sc_column_item_1 odd first">
                                            <div class="sc_dropcaps sc_dropcaps_style_1 margin_bottom_0.5em">
                                                <span class="sc_dropcaps_item">D</span>auris vitae quam ligula. In tincidunt sapien sed nibh scelerisque congue. Maecenas ut libero eu metus tincidunt lobortis. Duis accumsan at mauris vel lacinia. Cras cursus eros vel commodo tincidunt. Donec ac urna eget velit bibendum aliquam. Phasellus tempor urna erat, a fringilla elit vulputate in. Vivamus euismod mauris id sodales tincidunt. Dauris vitae quam ligula. In tincidunt sapien sed nibh scelerisque congue. Maecenas ut libero eu metus tincidunt lobortis.
                                            </div>
                                        </div><div class="column-1_2 sc_column_item sc_column_item_2 even">
                                            <div class="sc_dropcaps sc_dropcaps_style_3 margin_bottom_0.5em">
                                                <span class="sc_dropcaps_item">D</span>auris vitae quam ligula. In tincidunt sapien sed nibh scelerisque congue. Maecenas ut libero eu metus tincidunt lobortis. Duis accumsan at mauris vel lacinia. Cras cursus eros vel commodo tincidunt. Donec ac urna eget velit bibendum aliquam. Phasellus tempor urna erat, a fringilla elit vulputate in. Vivamus euismod mauris id sodales tincidunt. Dauris vitae quam ligula. In tincidunt sapien sed nibh scelerisque congue. Maecenas ut libero eu metus tincidunt lobortis.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2 margin_top_3em margin_bottom_tiny">
                                        <div class="column-1_2 sc_column_item sc_column_item_1 odd first">
                                            <div class="sc_dropcaps sc_dropcaps_style_2 margin_bottom_0.5em">
                                                <span class="sc_dropcaps_item">D</span>auris vitae quam ligula. In tincidunt sapien sed nibh scelerisque congue. Maecenas ut libero eu metus tincidunt lobortis. Duis accumsan at mauris vel lacinia. Cras cursus eros vel commodo tincidunt. Donec ac urna eget velit bibendum aliquam. Phasellus tempor urna erat, a fringilla elit vulputate in. Vivamus euismod mauris id sodales tincidunt. Dauris vitae quam ligula. In tincidunt sapien sed nibh scelerisque congue. Maecenas ut libero eu metus tincidunt lobortis.
                                            </div>
                                        </div><div class="column-1_2 sc_column_item sc_column_item_2 even">
                                            <div class="sc_dropcaps sc_dropcaps_style_4 margin_bottom_0.5em">
                                                <span class="sc_dropcaps_item">D</span>auris vitae quam ligula. In tincidunt sapien sed nibh scelerisque congue. Maecenas ut libero eu metus tincidunt lobortis. Duis accumsan at mauris vel lacinia. Cras cursus eros vel commodo tincidunt. Donec ac urna eget velit bibendum aliquam. Phasellus tempor urna erat, a fringilla elit vulputate in. Vivamus euismod mauris id sodales tincidunt. Dauris vitae quam ligula. In tincidunt sapien sed nibh scelerisque congue. Maecenas ut libero eu metus tincidunt lobortis.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <p>Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                                    <blockquote cite="#" class="sc_quote sc_quote_style_2">
                                    ...
                                    <figure class="sc_image alignleft sc_image_shape_square width_280 height_158">
                                        <img src="images/image-left-280x158.jpg" alt="" />
                                        <figcaption>Aligned left</figcaption>
                                    </figure>
                                    <p>Proin dignissim commodo magna at luctus. Nam molestie justo augue, nec eleifend urna laoreet non. Proin ut nulla egestas, hendrerit urna scelerisque, finibus nulla. Integer et elementum sem.</p>
                                    <p>Donec nec scelerisque elit, id pulvinar est. Maecenas laoreet, diam vel venenatis molestie, nec efficitur dui leo a tellus.</p>
                                    <p>Proin dignissim commodo magna at luctus. Nam molestie justo augue, nec eleifend urna laoreet non. Proin ut nulla egestas, hendrerit urna scelerisque, finibus nulla. Integer et elementum sem. Donec nec scelerisque elit, id pulvinar est.</p>
                                    <figure class="sc_image alignright sc_image_shape_square width_280 height_158">
                                        <a href="#">
                                            <img src="images/image-right-280x158.jpg" alt="" />
                                        </a>
                                    </figure>
                                    ...
                                    <p>Cras cursus eros vel commodo tincidunt. Donec ac urna eget velit bibendum aliquam. Phasellus tempor urna erat, a fringilla elit vulputate in. Vivamus euismod mauris id sodales tincidunt.Mauris vitae quam ligula.</p>
                                    <p>In tincidunt sapien sed nibh scelerisque congue. Maecenas ut libero eu metus tincidunt lobortis. Duis accumsan at mauris vel lacinia. Cras cursus eros vel commodo tincidunt. Donec ac urna eget velit bibendum aliquam. Phasellus tempor urna erat, a fringilla elit vulputate in. Vivamus euismod mauris id sodales tincidunt.</p>
                                    <!-- /Image alignment -->

                                    <!-- Lists -->
                                    <a id="toc_lists" class="sc_anchor" title="Lists" data-description="{Lists} - |Different list styles" data-icon="icon-menu-1" data-url="" data-separator="no"></a>
                                    <div class="sc_line sc_line_position_center_center sc_line_style_solid"></div>
                                        ...
                                        <div class="column-1_4 sc_column_item sc_column_item_1 odd first">
                                            <ul class="sc_list sc_list_style_iconed">
                                                <li class="sc_list_item odd first">
                                                    <span class="sc_list_icon icon-wechat"></span>Lorem ipsum
                                                </li>
                                                <li class="sc_list_item even">
                                                    <span class="sc_list_icon icon-wechat"></span>Dolor sit
                                                </li>
                                                <li class="sc_list_item odd">
                                                    <span class="sc_list_icon icon-wechat"></span>Consectetur
                                                </li>
                                                <li class="sc_list_item even">
                                                    <span class="sc_list_icon icon-wechat"></span>Adipisicing elit
                                                </li>
                                                <li class="sc_list_item odd">
                                                    <span class="sc_list_icon icon-wechat"></span>Sed do eiusmod
                                                </li>
                                            </ul>
                                        </div><div class="column-1_4 sc_column_item sc_column_item_2 even">
                                            <ul class="sc_list sc_list_style_iconed">
                                                <li class="sc_list_item odd first">
                                                    <span class="sc_list_icon icon-dot"></span>Lorem ipsum
                                                </li>
                                                <li class="sc_list_item even">
                                                    <span class="sc_list_icon icon-dot"></span>Dolor sit
                                                </li>
                                                <li class="sc_list_item odd">
                                                    <span class="sc_list_icon icon-dot"></span>Consectetur
                                                </li>
                                                <li class="sc_list_item even">
                                                    <span class="sc_list_icon icon-dot"></span>Adipisicing elit
                                                </li>
                                                <li class="sc_list_item odd">
                                                    <span class="sc_list_icon icon-dot"></span>Eiusmod
                                                </li>
                                            </ul>
                                        </div><div class="column-1_4 sc_column_item sc_column_item_3 odd">
                                            <ul class="sc_list sc_list_style_iconed">
                                                <li class="sc_list_item odd first">
                                                    <span class="sc_list_icon icon-right"></span>Lorem ipsum
                                                </li>
                                                <li class="sc_list_item even">
                                                    <span class="sc_list_icon icon-right"></span>Dolor sit
                                                </li>
                                                <li class="sc_list_item odd">
                                                    <span class="sc_list_icon icon-right"></span>Consectetur
                                                </li>
                                                <li class="sc_list_item even">
                                                    <span class="sc_list_icon icon-right"></span>Adipisicing elit
                                                </li>
                                                <li class="sc_list_item odd">
                                                    <span class="sc_list_icon icon-right"></span>Sed do eiusmod
                                                </li>
                                            </ul>
                                            ...
                                            <ol class="sc_list sc_list_style_ol">
                                                ...
                                                <li class="sc_list_item even">Dolor sit</li>
                                    ...
                                    <!-- Inputs -->
                                    <div class="sc_line sc_line_position_center_center sc_line_style_solid"></div>
                                   <h2 class="sc_title sc_title_regular">Inputs</h2>


                                    <div class="columns_wrap sc_columns columns_nofluid sc_columns_count_2">
                                        <div class="column-1_2 sc_column_item sc_column_item_2 odd">


                                            <div id="sc_form_1_typography_wrap" class="sc_form_wrap">
                                                <div id="sc_form_1_typography" class="sc_form sc_form_style_form_custom">
                                                    <form id="sc_form_1_typography_form" data-formtype="form_custom" method="post" action="#">
                                                        <div class="sc_form_item sc_form_item_text sc_form_field label_top">
                                                            <label for="sc_form_typography_1_1">Input Heading</label>
                                                            <input type="text" id="sc_form_typography_1_1" name="sc_form_typography_1_1" value="Input field example">
                                                        </div>
                                            ...
                                            <div id="sc_form_2_typography_wrap" class="sc_form_wrap">
                                                <div id="sc_form_2_typography" class="sc_form sc_form_style_form_custom">
                                                    <form id="sc_form_2_typography_form" data-formtype="form_custom" method="post" action="#">
                                                        <div class="sc_form_item sc_form_item_select sc_form_field label_top">
                                                            <label for="sc_form_2_1">Dropdown Heading</label>
                                                            <div class="sc_form_select_container">
                                                                <select id="sc_form_2_1" name="sc_form_2_1">
                                                                    <option value="big">options1</option>
                                                                    <option value="middle">options2</option>
                                                                    <option value="small">options3</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="result sc_infobox"></div>
...
<!-- Mirrored from newlife-church-html.axiomthemes.com/typography.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Nov 2019 13:30:46 GMT -->
</html>