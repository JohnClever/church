...
<!-- Mirrored from newlife-church-html.axiomthemes.com/page-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Nov 2019 13:30:51 GMT -->
<head>
        <meta charset="UTF-8" />
                                ...
                                <div class="post_content">
                                    ...
                                    <div class="column_404">
                                        ...
                                        <p class="page_description">Go back, or return to
                                            <a href="index.html">http://newlife-html.axiomthemes.com/</a>
                                            to choose a new page. Please report any broken links to our team.
                                        </p>
                                        <div class="back_button">
                                            <a class="sc_button sc_button_square sc_button_style_border sc_button_color_style_4 sc_button_size_large" href="index.html">Go back home</a>
                                        </div>
                                    </div>
                                </div>
                            </article>
                ...
                <footer class="contacts_wrap scheme_dark">
                    <div class="contacts_wrap_inner">
                        <div class="content_wrap">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="images/logo.png" class="logo_footer" alt="">
                                </a>
                            </div>
                            <div class="contacts_address">
                                <address class="address_right">
                                    <p class="margin_bottom_null">Phone: <a href="tel:1234567890">123-456-7890</a></p>
                                    <p class="margin_bottom_null">Fax: <a href="tel:0987654321">098-765-4321</a></p>
                                </address>
                                <address class="address_left">
                                    <p class="margin_bottom_null">Chicago, IL 6060</p>
