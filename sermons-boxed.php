...
<!-- Mirrored from newlife-church-html.axiomthemes.com/sermons-boxed.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Nov 2019 13:31:31 GMT -->
<head>
        <meta charset="UTF-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
        <meta name="format-detection" content="telephone=no">

        <title>Sermons Boxed &#8211; New Life Church</title>
    ...
    <body class="page body_style_wide body_filled article_style_stretch scheme_original top_panel_show top_panel_above sidebar_hide">
            ...
            <div class="page_wrap">
                ...
                <div class="top_panel_title top_panel_style_3 title_present breadcrumbs_present scheme_original">
                    <div class="top_panel_title_inner top_panel_inner_style_3 breadcrumbs_block_bg4">
                        <div class="content_wrap">
                            <h1 class="page_title">Sermons Boxed</h1>
                            <div class="breadcrumbs">
                                <a class="breadcrumbs_item home" href="index.php">Home</a>
                                <span class="breadcrumbs_delimiter"></span>
                                <span class="breadcrumbs_item current">Sermons Boxed</span>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <article class="post_item post_item_single page">
                                ...
                                <article class="myportfolio-container newlife-church" id="esg-grid-6-1-wrap">
                                    ...
                                    <div id="esg-grid-6-1" class="esg-grid" style="">
                                        <article class="esg-filters esg-singlefilters text_align_center margin_bottom_68">
                                            <!-- THE FILTER BUTTONS -->
                                            <div class="esg-filter-wrapper esg-fgc-6 margin_right_10 margin_left_10">
                                            ...
                                            <div class="esg-filter-wrapper eg-search-wrapper esg-fgc-6 margin_left_10 margin_right_10">
                                                <input name="eg-search-input-6" class="eg-search-input" type="text" value="" placeholder="Search...">
                                                <span class="eg-search-submit">
                                                    <i class="eg-icon-search"></i>
                                                </span>
                                                <span class="eg-search-clean">
                                                    <i class="eg-icon-cancel"></i>
                                                </span>
                                            </div>
                                            <!-- THE SORTING BUTTON -->
                                            <div class="esg-sortbutton-wrapper esg-fgc-6 margin_left_10 margin_right_10">
                                                <div class="esg-sortbutton">
                                                    <span>Sort By </span>
                                                    <span class="sortby_data">Date</span>
        ...
        <script type="text/javascript" src="js/essential-grid-sermons-boxed.min.js"></script>
...
<!-- Mirrored from newlife-church-html.axiomthemes.com/sermons-boxed.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Nov 2019 13:31:32 GMT -->
</html>